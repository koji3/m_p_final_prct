...
public:
   ...
   Lista(); 
	...
	/**
	* @brief Destructor. Libera todos los recursos reservados a la lista.
	*/
   ~Lista();
	...
	* @pre i debe ser menor que el tamaño total de la lista.
	...
	*/
	...
	/**
	 * @brief Operador de asignación de la clase Lista. Si ambos objetos son el mismo se devuelve un puntero a ese sin hacer nada más.
	 * @param Lista a copiar
	 * @return puntero a la lista recién asignada. 
	 */
	Lista& operator=(const Lista &otra);

	/**
	 * @brief Operador + de la clase Lista. Permite añadir un nuevo string a la lista usando el operador +
	 * @param String a añadir
	 * @return Puntero a la lista ya modificada. 
	 */
